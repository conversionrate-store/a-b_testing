...
/* Quantity row keeps its own flex layout; the host's gap-3 + ml-2 already give
   Figma's 20px between the stepper and Edit. */
[aria-labelledby='cart-lines-heading'] li.cart-line > div:last-child {
  grid-area: 3 / 2 / 4 / 3;
}
