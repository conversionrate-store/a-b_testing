...
[id*='_loomi_addon_'] {
  ...
  class Ce {
    ...
    async addPriceToBtn() {
      const e = async () => {
        var i, o;
        const t = await h("product-quick-add"), n = await h("button.wa-cart-btn"), s = (o = (i = t == null ? void 0 : t.querySelector("sale-price")) == null ? void 0 : i.textContent) == null ? void 0 : o.replace("Sale price", "").trim();
        if (n && s) {
