  ...
  class i {
    ...
    setupVideoAutoPause(n) {
      ...
      const e = n.closest('.card-box'),
        t = null == e ? void 0 : e.querySelectorAll(':scope > img, :scope > p');
      (n.addEventListener('loadedmetadata', () => {
        ...
        n.addEventListener('play', () => {
          ...
          const i = this.videoDurations.get(n) ?? 0;
          if (i > 0) {
        ...
        n.addEventListener('pause', () => {
          const i = null == e ? void 0 : e.querySelector('button .play');
          (n.ended || this.pauseSlider(),
            t &&
              t.forEach((n) => {
                n.style.display = '';
              }),
            (null == i ? void 0 : i.classList.contains('card-hidden')) &&
