!(function () {
    ...
    i = [
      {
        ...
        description:
          'We placed one calming <br> patch in her locket before <br> we left — and she just curled <br> up and relaxed',
      },
      {
        previewImageSrc: `${e}/preview_2.gif`,
        videoSrc: `${e}/reels_2.mp4`,
        description:
          'I used the patch before <br> grooming, and the groomer <br> said she did better than ever!',
      },
      {
        previewImageSrc: `${e}/preview_3.gif`,
        videoSrc: `${e}/reels_3.mp4`,
        description:
          "... I put one sticker in her <br>locket before a storm last  <br> night and she noticed it but <br> wasn't panicking as usual",
      },
    ];
  class t {
    constructor() {
    ...
    setVideoSource(n, e) {
      n.src = e;
      const i = n.querySelector('source');
      (i && (i.src = e), n.load());
    }
    updateCardItems(e) {
      e.querySelectorAll('.card-item').forEach((e, t) => {
        var o, s, r;
        ...
        a &&
          c &&
          d &&
          ((a.src = (null == (o = i[t]) ? void 0 : o.previewImageSrc) || ''),
          this.setVideoSource(
            c,
            (null == (s = i[t]) ? void 0 : s.videoSrc) || '',
          ),
          (d.innerHTML = `${(null == (r = i[t]) ? void 0 : r.description) || d.textContent}`),
    ...
    addActionButton() {
      var n, e;
      const i = document.querySelector('#in-action-cards');
      if (
        i &&
        !(null == (n = i.closest('.row'))
          ? void 0
          : n.querySelector('.crs-action-link'))
      ) {
        null == (e = i.closest('.row')) ||
            ...
            ((n, e, i, t = '') => {
              ((window.dataLayer = window.dataLayer || []),
                ...
                ((n, e = 'info') => {
                  ...
                  console.log(
                    `%c>>> ${n}`,
                    `${i} font-size: 16px; font-weight: 600`,
                  );
                })(`Event: ${n} | ${e} | ${i} | ${t}`, 'success'));
            })(
              'exp_video_click',
      ...
      if ('function' == typeof (null == e ? void 0 : e.slickSetOption)) {
        ...
        const i = () => {
            ...
            const t = window.getComputedStyle(e),
              o = Number.parseFloat(t.paddingLeft || '0') || 0,
              s = (e.clientWidth - i.clientWidth) / 2,
              r = Math.max(0, s - o);
  ...
  class o {
    ...
    init() {
      this.isTargetPage() && (this.addStyles(), new t());
    }
    isTargetPage() {
