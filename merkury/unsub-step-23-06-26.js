...
(function() {
	var e = ".mks-cancel__hidden {\n  display: none;\n}\n\n.mks-cancel {\n  position: relative;\n  width: 100%;\n  border-radius: 12px;\n  overflow: hidden;\n}\n.mks-cancel__bg {\n  position: absolute;\n  inset: 0;\n  z-index: 0;\n}\n.mks-cancel__bg::after {\n  content: \"\";\n  position: absolute;\n  inset: 0;\n  background: rgba(0, 0, 0, 0.5);\n}\n.mks-cancel__bg-img {\n  display: block;\n  width: 100%;\n  height: 100%;\n  -o-object-fit: cover;\n     object-fit: cover;\n  -o-object-position: bottom;\n     object-position: bottom;\n}\n.mks-cancel__inner {\n  position: relative;\n  z-index: 1;\n  height: 100%;\n  padding: 20px;\n  box-sizing: border-box;\n  display: flex;\n  flex-direction: column;\n  gap: 20px;\n}\n.mks-cancel__top {\n  display: flex;\n  flex-direction: column;\n  gap: 20px;\n}\n.mks-cancel__header {\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n}\n.mks-cancel__header-title {\n  font-family: Arial, sans-serif;\n  font-weight: 700;\n  font-size: 20px;\n  line-height: 28px;\n  color: #fff;\n}\n.mks-cancel__close {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  background: transparent;\n  border: none;\n  cursor: pointer;\n  padding: 0;\n  line-height: 0;\n}\n.mks-cancel__divider {\n  height: 1px;\n  background: rgba(255, 255, 255, 0.3);\n}\n.mks-cancel__body {\n  display: flex;\n  flex-direction: column;\n  gap: 16px;\n}\n.mks-cancel__hero {\n  display: flex;\n  align-items: flex-start;\n  gap: 12px;\n}\n.mks-cancel__hero-icon {\n  position: relative;\n  flex-shrink: 0;\n  width: 60px;\n  height: 60px;\n  background: rgba(255, 255, 255, 0.15);\n  backdrop-filter: blur(8px);\n  -webkit-backdrop-filter: blur(8px);\n  border-radius: 12px;\n}\n.mks-cancel__hero-camera {\n  position: absolute;\n  top: 8px;\n  left: 16px;\n  width: 27px;\n  height: 44px;\n  display: block;\n}\n.mks-cancel__hero-badge {\n  position: absolute;\n  bottom: 0;\n  right: 0;\n  width: 26px;\n  height: 26px;\n  display: block;\n}\n.mks-cancel__hero-title {\n  margin: 0;\n  flex: 1;\n  font-family: Arial, sans-serif;\n  font-weight: 700;\n  font-size: 20px;\n  line-height: 28px;\n  color: #fff;\n}\n.mks-cancel__hero-danger {\n  color: #ff5959;\n}\n.mks-cancel__features {\n  display: flex;\n  flex-direction: column;\n  gap: 8px;\n}\n.mks-cancel__feature {\n  display: flex;\n  align-items: flex-start;\n  gap: 12px;\n  padding: 12px;\n  background: rgba(255, 255, 255, 0.12);\n  backdrop-filter: blur(12px);\n  -webkit-backdrop-filter: blur(12px);\n  border-radius: 12px;\n  box-sizing: border-box;\n}\n.mks-cancel__feature-icon {\n  display: block;\n  flex-shrink: 0;\n  width: 24px;\n  height: 24px;\n}\n.mks-cancel__feature-icon--flip {\n  transform: scaleX(-1);\n}\n.mks-cancel__feature-body {\n  display: flex;\n  flex-direction: column;\n  gap: 4px;\n  flex: 1;\n}\n.mks-cancel__feature-title {\n  margin: 0;\n  font-family: Arial, sans-serif;\n  font-weight: 700;\n  font-size: 16px;\n  line-height: 24px;\n  color: #fff;\n}\n.mks-cancel__feature-desc {\n  margin: 0;\n  font-family: Arial, sans-serif;\n  font-weight: 400;\n  font-size: 14px;\n  line-height: 20px;\n  color: #fff;\n}\n.mks-cancel__actions {\n  margin-top: auto;\n  display: flex;\n  flex-direction: column;\n  gap: 12px;\n}\n.mks-cancel__btn {\n  display: block;\n  width: 100%;\n  height: 48px;\n  border-radius: 8px;\n  font-family: Arial, sans-serif;\n  font-weight: 500;\n  font-size: 14px;\n  line-height: 21px;\n  color: #fff;\n  cursor: pointer;\n  box-sizing: border-box;\n  letter-spacing: -0.15px;\n}\n.mks-cancel__btn--primary {\n  background: #37766f;\n  border: 1px solid #37766f;\n}\n.mks-cancel__btn--secondary {\n  background: transparent;\n  border: 1px solid #fff;\n}/*# sourceMappingURL=style.css.map */", t = (e, t, n, r = "") => {
		...
		camera: "<svg xmlns=\"http://www.w3.org/2000/svg\" width=\"60\" height=\"71\" viewBox=\"0 0 60 71\" fill=\"none\">\n		<foreignObject x=\"-16\" y=\"-16\" width=\"92\" height=\"92\"><div xmlns=\"http://www.w3.org/1999/xhtml\" style=\"backdrop-filter:blur(8px);clip-path:url(#bgblur_0_166_2269_clip_path);height:100%;width:100%\"></div></foreignObject><path data-figma-bg-blur-radius=\"16\" d=\"M0 12C0 5.37258 5.37258 0 12 0H48C54.6274 0 60 5.37258 60 12V48C60 54.6274 54.6274 60 48 60H12C5.37258 60 0 54.6274 0 48V12Z\" fill=\"white\" fill-opacity=\"0.15\"/>\n		<path d=\"M16.3438 22.6656C16.3438 16.0547 21.659 10.6938 28.2179 10.6938H31.7802C38.3391 10.6938 43.6543 16.0547 43.6543 22.6656V35.5371C43.6543 42.1506 38.3391 47.5088 31.7802 47.5088H28.2179C21.659 47.5115 16.3438 42.1506 16.3438 35.5371V22.6656Z\" fill=\"#9DA4B0\"/>\n		<path d=\"M16.3438 19.9717C16.3438 13.3609 21.659 8 28.2179 8H31.7802C38.3391 8 43.6543 13.3609 43.6543 19.9717V32.8432C43.6543 39.4568 38.3391 44.815 31.7802 44.815H28.2179C21.659 44.8177 16.3438 39.4568 16.3438 32.8432V19.9717Z\" fill=\"#CED2D8\"/>\n		<ellipse cx=\"29.9101\" cy=\"33.7417\" rx=\"0.890527\" ry=\"0.897971\" fill=\"#81BB42\"/>\n		<ellipse cx=\"29.9101\" cy=\"36.7344\" rx=\"0.890527\" ry=\"0.897971\" fill=\"white\"/>\n		<ellipse cx=\"29.9094\" cy=\"21.1701\" rx=\"6.82737\" ry=\"6.88444\" fill=\"#EFF0F2\"/>\n		<ellipse cx=\"29.9095\" cy=\"21.1701\" rx=\"5.64\" ry=\"5.68714\" fill=\"#393F48\"/>\n		<ellipse cx=\"29.9097\" cy=\"21.1705\" rx=\"4.15579\" ry=\"4.19053\" fill=\"#81BB42\"/>\n		<ellipse cx=\"29.906\" cy=\"21.17\" rx=\"2.67158\" ry=\"2.69391\" fill=\"#393F48\"/>\n		<ellipse opacity=\"0.4\" cx=\"31.6912\" cy=\"19.3745\" rx=\"1.48421\" ry=\"1.49662\" fill=\"white\"/>\n		<path d=\"M19.2227 50.5035C19.2227 48.8504 20.5517 47.5103 22.1911 47.5103H37.6269C39.2663 47.5103 40.5953 48.8504 40.5953 50.5035V52.0001H19.2227V50.5035Z\" fill=\"#CED2D8\"/>\n		<ellipse cx=\"47\" cy=\"58\" rx=\"13\" ry=\"13\" fill=\"white\"/>\n		<path d=\"M51.2768 52.2959C51.6705 51.902 52.3088 51.902 52.7025 52.2959C53.096 52.6897 53.0961 53.3279 52.7025 53.7216L48.4252 57.999L52.7035 62.2783C53.0973 62.6721 53.0973 63.3112 52.7035 63.705C52.3098 64.0986 51.6714 64.0988 51.2777 63.705L46.9994 59.4257L42.7211 63.705C42.3274 64.0988 41.6891 64.0985 41.2953 63.705C40.9016 63.3112 40.9016 62.6721 41.2953 62.2783L45.5727 57.999L41.2963 53.7216C40.9027 53.3279 40.9027 52.6897 41.2963 52.2959C41.6901 51.902 42.3283 51.902 42.7221 52.2959L46.9994 56.5732L51.2768 52.2959Z\" fill=\"#B30000\"/>\n		<defs>\n		<clipPath id=\"bgblur_0_166_2269_clip_path\" transform=\"translate(16 16)\"><path d=\"M0 12C0 5.37258 5.37258 0 12 0H48C54.6274 0 60 5.37258 60 12V48C60 54.6274 54.6274 60 48 60H12C5.37258 60 0 54.6274 0 48V12Z\"/>\n		</clipPath></defs>\n		</svg>"
	}, c = `
    ...
    <div class="mks-cancel__inner">
      ...
      <div class="mks-cancel__body">
        <div class="mks-cancel__hero">
          <div class="mks-cancel__hero-icon">${s.camera}</div>
