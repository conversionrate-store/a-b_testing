...
`;
  A({ name: "Іmproved registration / account creation flow", dev: "OS" }), I("exp_login_modal");
  const z = {
    regexpLinks: {
  ...
  class H {
      ...
      try {
        ...
        if (i.forEach((a) => {
          ...
          if (s) {
            ...
            if (!g && (!u || u.trim() === ""))
              return;
            l.dataset.bg = g || u, l.dataset.productTitle = (r == null ? void 0 : r.title) || a || "", s.style.backgroundImage = "none", s.classList.add("crs-modal-bg"), s.innerHTML = /* HTML */
            `
    ...
    getSellerData() {
      ...
      ), u = !!c, l = ((x = c == null ? void 0 : c.textContent) == null ? void 0 : x.trim().replace(/\s+/g, " ")) || "", i = !!(o != null && o.querySelector(".fa-badge-check")), s = (q = e == null ? void 0 : e.querySelector(".fa-thumbs-up")) == null ? void 0 : q.parentElement, a = (((M = s == null ? void 0 : s.textContent) == null ? void 0 : M.trim()) || "").match(/([\d.]+)%/), g = a ? parseFloat(a[1]) : 0, p = Array.from(
