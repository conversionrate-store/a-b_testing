...
`, h = class h {
    ...
    handleTouchStart(t) {
      const e = t;
      this.touchStartX = e.touches[0].clientX, this.touchStartTime = Date.now(), this.isDragging = !0, this.scrollContainer && (this.scrollContainer.style.transition = "none");
    }
    handleTouchMove(t) {
      if (!this.isDragging || !this.scrollContainer) return;
      const e = t;
      this.touchCurrentX = e.touches[0].clientX;
      const o = this.touchCurrentX - this.touchStartX;
      this.currentTranslate = this.prevTranslate + o, this.scrollContainer.style.transform = `translateX(${this.currentTranslate}px)`;
    }
    handleTouchEnd(t) {
      if (!this.isDragging || !this.scrollContainer) return;
      this.isDragging = !1;
    ...
    cleanup() {
      this.prevButton && this.prevHandler && this.prevButton.removeEventListener("click", this.prevHandler), this.nextButton && this.nextHandler && this.nextButton.removeEventListener("click", this.nextHandler), this.eventHandlers.forEach(({ element: t, event: e, handler: o }) => {
        t.removeEventListener(e, o);
      }), this.eventHandlers = [], this.scrollContainer = null, this.prevButton = null, this.nextButton = null, this.prevHandler = null, this.nextHandler = null, this.currentSlide = 0, this.isAnimating = !1, this.isDragging = !1, this.touchStartX = 0, this.touchCurrentX = 0, this.currentTranslate = 0, this.prevTranslate = 0, this.touchStartTime = 0;
    }
    addStyles() {
