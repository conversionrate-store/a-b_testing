...
`;
  class _ {
    ...
    async setFilters() {
      ...
      n && (await r(".all-apps__filters-bar > button"), setTimeout(() => {
        document.querySelectorAll(
          ".all-apps__filters-bar > button"
        ).forEach((a) => {
          n.includes(a.value) && (console.log(`Clicking button with value: ${a.value}`), a.click());
        });
      }, 500));
    }
  }
