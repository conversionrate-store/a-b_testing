...
`
  ...
  var B = T();
  const M = /* @__PURE__ */ j(B);
  v("exp_new_upload_photo"), k({ name: "Hair block", dev: "YK" }), function() {
  ...
  class H {
    ...
    async createHairBlock() {
      ...
      window.addEventListener("sessionStorageChange", (t) => {
        ...
        n === "uploadedFile" && (window.ExternalUploader.closeModal(), o(".page-content").elements[0].insertAdjacentHTML("beforebegin", E));
      });
    }
    async sendImageToEditor() {
      ...
      this.generationId = i.generation_id, o(".snap-block").elements[0].insertAdjacentHTML("afterend", u), o(".snap-block").elements[0].remove(), o(".photo-block").attr(
        "style",
    ...
    async usedBlocks(e) {
      await h(".page-content"), o(".page-content").elements[0].insertAdjacentHTML("beforebegin", u), o(".photo-block-wrapper>h3").text("Your new look is ready 🎉"), o(".photo-block-wrapper>h3+p").text("Enjoy your transformation — you look amazing!"), o(".photo-block .timer").elements[0].remove(), o(".photo-block").html(`${b(e)}<img src="${e}" alt="Generated hairstyle" />`), o(".try-another button").on("click", () => {
  ...
  window.innerWidth < 769 && window.location.pathname.includes("/virtual-styler-test/step-1") && new H();
})();
