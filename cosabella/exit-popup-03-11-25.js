...
.crs_exit_popup .image {
  background: url("https://conversionrate-store.github.io/a-b_images/cosabella/exit-popup-d.webp") center center no-repeat;
  background-size: cover;
}
@media (max-width: 768px) {
  .crs_exit_popup .image {
    background: url("https://conversionrate-store.github.io/a-b_images/cosabella/exit-popup-m.webp") center center no-repeat;
    background-size: cover;
    height: 230px;
    padding: 115px 0;
    flex-grow: 0;
  ...
  class c {
    ...
    each(t) {
      for (let e of this.elements)
        t(new c(e), this.elements.indexOf(e));
      return this;
    }
    style(t, e) {
  ...
  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
    ...
    />
      ...
      <div class="content">
        ...
        <p>Your selected items are nearly sold out</p>
        <div class="timer">
