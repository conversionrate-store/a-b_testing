  ...
  class H {
    constructor() {
      ...
      this.countryCode = (n = (e = window == null ? void 0 : window.autoInitData) == null ? void 0 : e.website) == null ? void 0 : n.websiteCode, this.basketButtonHandler = () => {
        (() => {
          !location.href.includes("basket") && !location.href.includes("checkout") && f('minibasket a[href*="/basket"]').then((a) => {
            var d;
            const o = a, c = o.href;
            this.country;
            const i = (
    ...
    init() {
      if (!(this.country !== "de" && this.country !== "fr"))
        try {
    ...
    async addPaypalMessageBadgeOnBasketPage() {
      ...
      if (window.location.pathname.includes("/basket")) {
        ...
        if (b) {
          ...
          const v = document.querySelector(
            "#crs-paypal-basket"
          ), y = (n = document.querySelector("[data-pp-amount]")) == null ? void 0 : n.getAttribute("data-pp-amount"), h = (o = (a = (r = window == null ? void 0 : window.autoInitData) == null ? void 0 : r.website) == null ? void 0 : a.currency) == null ? void 0 : o.base, g = (i = (c = window == null ? void 0 : window.autoInitData) == null ? void 0 : c.website) == null ? void 0 : i.defaultCountry;
          if (!y || !h) return;
          const p = setInterval(() => {
      ...
      } else if (await f("product-view-add-to-basket")) {
        ...
        setTimeout(() => {
          document.querySelector("#crs-paypal-product") || h.insertAdjacentHTML("afterend", y);
        }, 1e3);
        const g = setInterval(() => {
          window != null && window.paypal && f("#crs-paypal-product").then(() => {
            var p;
            paypal.Messages({
              amount: m,
              currency: w,
