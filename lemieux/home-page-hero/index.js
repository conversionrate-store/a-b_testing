...
`, W = "https://ab.conversionrate.store/lemieux/home-page-hero/img", ce = [
    {
      ...
      title: { sub: "Performance in <br/> all Weathers", main: "Winter Essentials" },
      button: {
        text: "Explore Now",
        href: "/new-in/winter-essentials"
      },
...
icms-component:has(.crs-hero) > div:not(.crs-hero):not(.crs-app-promo) {
  display: none;
}
...
[data-hero='winter-essentials'] .crs-block-title .sub-title br {
  display: none;
}
...
@media (max-width: 700px) {
  ...
  [data-hero='winter-essentials'] img {
    aspect-ratio: 1130 / 818;
  }

  [data-hero='winter-essentials']::after {
    content: '';
    position: absolute;
    top: 0;
    left: 0;
...
>`
  ...
  class Ke {
    ...
    async findBanner() {
      const e = await G('[data-crs-marker="extra-10%-off-outlet---use-code:-lm-app10"]'), s = await G(".crs-hero-section");
  ...
  const q = class q {
    ...
    async addNewHeroSection() {
      try {
        const e = await G(q.TARGET_SELECTOR);
        if (!e) {
        ...
        N(e, "Error changing hero image section");
      }
    }
    replaceHeroContent(e) {
      const s = e.querySelector(q.HERO_CLASS);
      s && s.remove(), this.eventsAborter && this.eventsAborter.abort();
  ...
  display: none !important;
    ...
    init() {
      try {
        ...
        N(e, "Error initializing Hide Sections");
      }
    }
    async hideSection() {
      try {
        const e = await G(".page-view-boundary"), s = e == null ? void 0 : e.querySelectorAll(
    ...
    processInitialComponents(e) {
      e.forEach((s) => {
        try {
          ...
          N(i, "Processing initial component");
        }
      });
    }
    hideComponent(e) {
  ...
  [data-crs-title='Popular Categories'] page-component-category-carousel {
    ...
    init() {
      try {
        ...
        N(e, "Error initializing Popular Categories");
      }
    }
    async modifySection() {
      try {
    ...
    initSlider() {
      ...
      e.style.cursor = "grab";
      let s = !1, i = 0, n = 0, r = 0, o = 0;
      e.addEventListener(
        "mousedown",
        (l) => {
          l.preventDefault(), s = !0, i = l.pageX, n = l.pageY, r = e.scrollLeft, o = e.scrollTop;
        },
        { signal: this.eventsAborter.signal }
      ), e.addEventListener(
        "mouseleave",
  ...
  class st {
    ...
    init() {
      try {
        ...
        N(e, "Error initializing Outfit Builder section");
      }
    }
    async render() {
      try {
        ...
        N(e, "Error rendering Outfit Builder section");
      }
    }
    setupEvents() {
...
`;
  ...
  function Ie({
    ...
    const a = e > n ? "next" : "prev", u = (p, w) => a === "next" && p >= w || a === "prev" && p <= w, m = () => {
      ...
      const p = Math.max(Math.min((o - r) / l, 1), 0), w = 0.5 - Math.cos(p * Math.PI) / 2;
      let d = n + w * (e - n);
  ...
  function vt() {
    ...
    if (i()) {
      ...
      if (l.includes("Version/")) {
        const [a, u] = l.split("Version/")[1].split(" ")[0].split(".").map((m) => Number(m));
        s = a < 16 || a === 16 && u < 2;
      }
    }
    const n = /(iPhone|iPod|iPad).*AppleWebKit(?!.*Safari)/i.test(t.navigator.userAgent), r = i(), o = r || n && e.ios;
    return {
      isSafari: s || r,
  ...
  function Dt(t = 0, e = this.params.speed, s = !0, i = !0, n) {
    ...
    let m;
    if (i && t > a ? m = a : i && t < u ? m = u : m = t, r.updateProgress(m), o.cssMode) {
  ...
  function Vt(t = 0, e, s = !0, i, n) {
    ...
    if (!g && !i && !n || r.destroyed || r.animating && l.preventInteractionOnTransition)
      return !1;
    ...
    if (l.normalizeSlideIndex)
      for (let C = 0; C < u.length; C += 1) {
        ...
        typeof u[C + 1] < "u" ? y >= I && y < T - (T - I) / 2 ? o = C : y >= I && y < T && (o = C + 1) : y >= I && (o = C);
      }
    if (r.initialized && o !== p && (!r.allowSlideNext && (w ? c > r.translate && c > r.minTranslate() : c < r.translate && c < r.minTranslate()) || !r.allowSlidePrev && c > r.translate && c > r.maxTranslate() && (p || 0) !== o))
      return !1;
    o !== (m || 0) && s && r.emit("beforeSlideChangeStart"), r.updateProgress(c);
    let f;
    o > p ? f = "next" : o < p ? f = "prev" : f = "reset";
    const h = r.virtual && r.params.virtual.enabled;
    if (!(h && n) && (w && -c === r.translate || !w && c === r.translate))
      return r.updateActiveIndex(o), l.autoHeight && r.updateAutoHeight(), r.updateSlidesClasses(), l.effect !== "slide" && r.setTranslate(c), f !== "reset" && (r.transitionStart(s, f), r.transitionEnd(s, f)), !1;
    if (l.cssMode) {
  ...
  function jt(t = 0, e, s = !0, i) {
    ...
    if (n.params.loop)
      if (n.virtual && n.params.virtual.enabled)
        ...
        let g = a - l < d;
        if (w && (g = g || l < Math.ceil(d / 2)), i && w && n.params.slidesPerView !== "auto" && !r && (g = !1), g) {
          const v = w ? l < n.activeIndex ? "prev" : "next" : l - n.activeIndex - 1 < n.params.slidesPerView ? "next" : "prev";
          n.loopFix({
            direction: v,
            slideTo: !0,
  ...
  function Ft(t, e = !0, s) {
    ...
    let c = 0;
    if (typeof x < "u" && (c = o.indexOf(x), c < 0 && (c = i.activeIndex - 1), n.slidesPerView === "auto" && n.slidesPerGroup === 1 && n.slidesPerGroupAuto && (c = c - i.slidesPerViewDynamic("previous", !0) + 1, c = Math.max(c, 0))), n.rewind && i.isBeginning) {
  ...
  function Yt(t, e = !0, s, i = 0.5) {
    ...
    if (a >= n.snapGrid[l]) {
      const u = n.snapGrid[l], m = n.snapGrid[l + 1];
      a - u > (m - u) * i && (r += n.params.slidesPerGroup);
    } else {
      const u = n.snapGrid[l - 1], m = n.snapGrid[l];
      a - u <= (m - u) * i && (r -= n.params.slidesPerGroup);
    }
  ...
  function Jt({
    ...
    if (a.allowSlidePrev = m, a.allowSlideNext = p, a.controller && a.controller.control && !o) {
      const L = {
        slideRealIndex: t,
        direction: s,
        setTranslate: i,
  ...
  function ns(t) {
    ...
    if (!l || !r.simulateTouch && i.pointerType === "mouse" || e.animating && r.preventInteractionOnTransition)
      return;
  ...
  function rs(t) {
    ...
    if (n.touchReleaseOnEdges && !n.loop)
      if (s.isVertical()) {
        ...
        if (o && (m > r.startX && -s.translate <= s.maxTranslate() || m < r.startX && -s.translate >= s.minTranslate()))
          return;
        if (!o && (m < r.startX && s.translate <= s.maxTranslate() || m > r.startX && s.translate >= s.minTranslate()))
          return;
      }
  ...
  function as(t) {
    ...
    if (!m || !o.simulateTouch && i.pointerType === "mouse") return;
    if (s.allowTouchCallbacks && e.emit("touchEnd", i), s.allowTouchCallbacks = !1, !s.isTouched) {
      s.isMoved && o.grabCursor && e.setGrabCursor(!1), s.isMoved = !1, s.startMoving = !1;
      return;
    }
    ...
    s.isTouched = !1, s.isMoved = !1, s.startMoving = !1;
    let d;
    if (o.followFinger ? d = a ? e.translate : -e.translate : d = -s.currentTranslate, o.cssMode)
      return;
    ...
    for (let S = 0; S < u.length; S += S < o.slidesPerGroupSkip ? 1 : o.slidesPerGroup) {
      const k = S < o.slidesPerGroupSkip - 1 ? 1 : o.slidesPerGroup;
      typeof u[S + k] < "u" ? (g || d >= u[S] && d < u[S + k]) && (v = S, x = u[S + k] - u[S]) : (g || d >= u[S]) && (v = S, x = u[u.length - 1] - u[u.length - 2]);
    }
    let c = null, f = null;
    o.rewind && (e.isBeginning ? f = o.virtual && o.virtual.enabled && e.virtual ? e.virtual.slides.length - 1 : e.slides.length - 1 : e.isEnd && (c = 0));
    const h = (d - u[v]) / x, b = v < o.slidesPerGroupSkip - 1 ? 1 : o.slidesPerGroup;
    if (w > o.longSwipesMs) {
      if (!o.longSwipes) {
        e.slideTo(e.activeIndex);
        return;
      }
      e.swipeDirection === "next" && (h >= o.longSwipesRatio ? e.slideTo(o.rewind && e.isEnd ? c : v + b) : e.slideTo(v)), e.swipeDirection === "prev" && (h > 1 - o.longSwipesRatio ? e.slideTo(v + b) : f !== null && h < 0 && Math.abs(h) > o.longSwipesRatio ? e.slideTo(f) : e.slideTo(v));
    } else {
      if (!o.shortSwipes) {
        e.slideTo(e.activeIndex);
        return;
  ...
  const $e = (t, e) => {
    const s = U(), {
      ...
      wrapperEl: r,
      device: o
    } = t, l = !!i.nested, a = e === "on" ? "addEventListener" : "removeEventListener", u = e;
  ...
  class V {
    ...
    destroy(e = !0, s = !0) {
      ...
      return typeof i.params > "u" || i.destroyed || (i.emit("beforeDestroy"), i.initialized = !1, i.detachEvents(), n.loop && i.loopDestroy(), s && (i.removeClasses(), r && typeof r != "string" && r.removeAttribute("style"), o && o.removeAttribute("style"), l && l.length && l.forEach((a) => {
  ...
  function _s({
    ...
    s("init", () => {
      t.params.navigation.enabled === !1 ? w() : (u(), o());
...
`, Re = "/tco-images/unsafe/1730x1703/filters:upscale():fill(white):quality(70)/https://www.lemieux.com/static/cms/media/AW25-Web-Banners 946px x 709px -M_DT.jpg", F = class F {
    ...
    async addNewColours() {
      var n;
      const e = await G(F.TARGET_SELECTOR);
      ...
      this.setupMutationObserver(), this.attachExistingSwatchListeners();
    }
    attachExistingSwatchListeners() {
      if (!this.swatchContainer) return;
      const e = this.swatchContainer.querySelectorAll(".swatch-outer"), s = Array.from(this.addedSwatches.values());
      e.forEach((i) => {
        var r;
        const n = i.closest("._swatchContainer");
        if (n) {
          const o = n.parentElement;
          if (!s.includes(o)) {
            const l = n.querySelector(".color-tile__tooltip"), a = ((r = l == null ? void 0 : l.textContent) == null ? void 0 : r.trim()) || "", u = () => {
              this.ensureHeroImages(), this.clearNewSwatchSelection(), this.resetHeroImage(), this.isTouchDevice && a && this.addHeroLabel(a);
            }, m = () => {
              this.ensureHeroImages(), this.clearNewSwatchSelection(), this.resetHeroImage(), !this.isTouchDevice && a && this.addHeroLabel(a);
            }, p = () => {
              this.isTouchDevice || this.removeHeroLabel();
            };
            n.addEventListener("click", u), n.addEventListener("mouseenter", m), n.addEventListener("mouseleave", p), this.existingSwatchListeners.set(n, {
              click: u,
              mouseenter: m,
              mouseleave: p
            });
    ...
    clearNewSwatchSelection() {
      this.addedSwatches.forEach((e) => {
        const s = e.querySelector(".swatch-inner--huge"), i = e.querySelector(".swatch-outer");
        s && s.classList.remove("is-checked"), i && (i.classList.remove("b-col-b"), i.classList.add("b-col-t"));
      }), this.selectedSwatchName = null, this.resetHeroImage();
    }
    ...
    selectSwatch(e, s, i) {
      if (this.ensureHeroImages(), this.swatchContainer) {
        const o = this.swatchContainer.querySelectorAll(
          ".swatch-inner--huge"
        ), l = this.swatchContainer.querySelectorAll(".swatch-outer");
        o.forEach((a) => {
          a.classList.remove("is-checked");
        }), l.forEach((a) => {
          a.classList.remove("b-col-b"), a.classList.add("b-col-t");
        });
      }
      const n = i.querySelector(".swatch-inner--huge"), r = i.querySelector(".swatch-outer");
      n && n.classList.add("is-checked"), r && (r.classList.remove("b-col-t"), r.classList.add("b-col-b")), this.selectedSwatchName = e, this.setHeroImage(s);
    }
    addSwatchCheckedClasses(e) {
      if (this.swatchContainer) {
        const n = this.swatchContainer.querySelectorAll(
          ".swatch-inner--huge"
        ), r = this.swatchContainer.querySelectorAll(".swatch-outer");
        n.forEach((o) => {
          o.classList.remove("is-checked");
        }), r.forEach((o) => {
          o.classList.remove("b-col-b"), o.classList.add("b-col-t");
        });
      }
      const s = e.querySelector(".swatch-inner--huge"), i = e.querySelector(".swatch-outer");
      s && s.classList.add("is-checked"), i && (i.classList.remove("b-col-t"), i.classList.add("b-col-b"));
    }
    removeSwatchCheckedClasses(e) {
      const s = e.querySelector(".swatch-inner--huge"), i = e.querySelector(".swatch-outer");
      s && s.classList.remove("is-checked"), i && (i.classList.remove("b-col-b"), i.classList.add("b-col-t"));
    }
    insertColourSwatch(e, s, i, n, r, o) {
      var g;
      const l = e.querySelectorAll(":scope > div");
      let a = -1;
      for (let v = 0; v < l.length; v++) {
        const x = l[v].querySelector(".color-tile__tooltip");
        if (((g = x == null ? void 0 : x.textContent) == null ? void 0 : g.trim()) === o) {
          a = v;
          break;
        }
      }
      if (a === -1) {
        console.warn(
          `ColoursSection: Could not find anchor colour "${o}" for "${s}"`
        );
        return;
      }
      ...
      if (w) {
        const v = (f) => {
          this.isTouchDevice ? (this.ensureHeroImages(), this.selectedSwatchName === s ? window.location.href = n : (f.preventDefault(), this.selectSwatch(s, r, p), this.addHeroLabel(s))) : window.location.href = n;
        }, x = () => {
          this.isTouchDevice || setTimeout(() => {
            this.ensureHeroImages(), this.addSwatchCheckedClasses(p), this.setHeroImage(r), this.addHeroLabel(s);
          }, 0);
        }, c = () => {
          this.isTouchDevice || (this.removeSwatchCheckedClasses(p), this.resetHeroImage(), this.removeHeroLabel());
        };
    ...
    createSwatchHTML(e, s, i, n) {
      return `
      <div class="ng-star-inserted">
        <div class="pos-relative inline-block _swatchContainer m-l-1 m-r-1 m-b-2 m-b-3-s" data-href="${i}" data-image="${n}">
    ...
    ensureHeroImages() {
      ...
      this.heroImages = Array.from(
        (e == null ? void 0 : e.querySelectorAll("img.df-image")) || []
      );
    }
    addHeroLabel(e) {
      if (!this.targetSection) return;
      this.removeHeroLabel();
      let s = this.targetSection.querySelector("href.fill");
      if (s && s.parentNode) {
        const n = document.createElement("div");
        n.className = "bg-col-w p-t-10 p-b-10 p-l-10 p-r-12 pos-absolute top-50 left-10 z-4 overflow-wrap ng-star-inserted", n.innerHTML = `<p class="hero">${e}</p>`, s.parentNode.insertBefore(n, s);
        return;
      }
      const i = this.targetSection.querySelector("swiper");
      if (i && i.parentNode) {
        const n = document.createElement("div");
        n.className = "bg-col-w p-a-2 pos-absolute z-1 bottom-10 left-50 z-4 ng-star-inserted", n.innerHTML = `<p class="hero center-s">${e}</p>`, i.parentNode.insertBefore(
          n,
          i.nextSibling
        );
      }
    ...
    removeHeroLabel() {
      this.targetSection && (this.targetSection.querySelectorAll(
        ".bg-col-w.p-t-10.p-b-10.p-l-10.p-r-12.pos-absolute.top-50.left-10.z-4.overflow-wrap.ng-star-inserted"
      ).forEach((i) => {
        i.querySelector("p.hero") && i.parentNode && i.parentNode.removeChild(i);
      }), this.targetSection.querySelectorAll(
        ".bg-col-w.p-a-2.pos-absolute.z-1.bottom-10.left-50.z-4.ng-star-inserted"
      ).forEach((i) => {
        i.querySelector("p.hero.center-s") && i.parentNode && i.parentNode.removeChild(i);
      }));
    }
    destroy() {
      this.swatchContainerObserver && (this.swatchContainerObserver.disconnect(), this.swatchContainerObserver = null), this.existingSwatchListeners.forEach((e, s) => {
        s.removeEventListener("click", e.click), s.removeEventListener("mouseenter", e.mouseenter), s.removeEventListener("mouseleave", e.mouseleave);
      }), this.existingSwatchListeners.clear(), this.addedSwatches.forEach((e, s) => {
        if (!document.contains(e))
          return;
        const i = e.querySelector("._swatchContainer");
        if (i) {
          const n = i._clickHandler, r = i._mouseEnterHandler, o = i._mouseLeaveHandler;
          n && i.removeEventListener("click", n), r && i.removeEventListener("mouseenter", r), o && i.removeEventListener("mouseleave", o), delete i._clickHandler, delete i._mouseEnterHandler, delete i._mouseLeaveHandler;
        }
