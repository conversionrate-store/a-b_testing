...
`;
      ...
      if (!(_ && (C && t.grid.updateSlide(T, _, u), Y(_, "display") === "none"))) {
        if (o && s.slidesPerView === "auto")
          ...
          if (I && (_.style.transform = "none"), O && (_.style.webkitTransform = "none"), s.roundLengths)
            ...
            const B = e(E, "width"), We = e(E, "padding-left"), K = e(E, "padding-right"), P = e(E, "margin-left"), A = e(E, "margin-right"), $ = E.getPropertyValue("box-sizing");
            if ($ && $ === "border-box")
              y = B + P + A;
            else {
              const {
  ...
  function kt() {
    ...
    a && (l || (m = gt(a, `.${s.slideClass}, swiper-slide`)[0], s.loop && !m && (m = e[0]), u = ft(a, `.${s.slideClass}, swiper-slide`)[0], s.loop && !u === 0 && (u = e[e.length - 1]))), e.forEach((p) => {
  ...
  function It(t) {
    ...
    if (typeof a > "u" && (a = Pt(e)), i.indexOf(s) >= 0)
      u = i.indexOf(s);
    else {
  ...
  function us() {
    ...
    t.onTouchStart = ns.bind(t), t.onTouchMove = rs.bind(t), t.onTouchEnd = as.bind(t), t.onDocumentTouchStart = ds.bind(t), e.cssMode && (t.onScroll = os.bind(t)), t.onClick = ls.bind(t), t.onLoad = cs.bind(t), qe(t, "on");
  }
  function ps() {
    qe(this, "off");
  }
  ...
  class R {
    ...
    destroy(e = !0, s = !0) {
      ...
      return typeof i.params > "u" || i.destroyed || (i.emit("beforeDestroy"), i.initialized = !1, i.detachEvents(), n.loop && i.loopDestroy(), s && (i.removeClasses(), r && typeof r != "string" && r.removeAttribute("style"), l && l.removeAttribute("style"), o && o.length && o.forEach((a) => {
        ...
        i.off(a);
      }), e !== !1 && (i.el && typeof i.el != "string" && (i.el.swiper = null), lt(i)), i.destroyed = !0), null;
    }
  ...
  const M = class M {
    ...
    addStyles() {
      ...
      const e = document.createElement("style");
      e.id = M.STYLES_ID, e.textContent = nt, document.head.appendChild(e);
    }
    destroy() {
