!(function () {
  ...
  startLog({
    name: 'Early Pricing Selection to Simplify Payment Step',
    dev: 'OS',
  });
  ...
  const n = (n) => {
    ...
    o = {
      Standard: [],
      'Priority GOV+ Courier': [
        'Guaranteed timeline',
        'Priority processing',
        'Best for upcoming travel',
      ],
      'Express GOV+ Courier': [
        'Guaranteed timeline',
        'Fastest processing ',
    ...
    a = {
      Standard:
        'Processing times start once documents are received. Government fees paid separately later in the application',
      'Priority GOV+ Courier':
        'Processing times start once documents are received. Government fees payable on the next page',
      'Express GOV+ Courier':
        'Processing times start once documents are received. Government fees payable on the next page',
    };
  class r {
    constructor() {
      ((this.paymentsSelector = '.PaymentCombinedInformation'),
        ...
        (this.newPaymentMethodsContainerId =
          '.ant-form-item:has(button[type="submit"])'),
        (this.paymentMethodStorageKey = 'crs:selectedPaymentMethodId'),
        (this.isProcessing = !1),
        (this.isRendering = !1),
    ...
    init() {
      const n =
          'payment' === new URLSearchParams(window.location.search).get('page'),
        e = localStorage.getItem(this.paymentMethodStorageKey);
      !n || e
        ? (this.cleanUp(),
    ...
    persistSelectedPaymentMethod(n) {
      try {
        if (!n)
    ...
    restoreSelectedPaymentMethod() {
      try {
        this.selectedPaymentMethodId = localStorage.getItem(
          this.paymentMethodStorageKey,
        );
      } catch (n) {
        (console.error('Unable to restore selected payment method:', n),
          (this.selectedPaymentMethodId = null));
      }
    }
    async renderNewPaymentMethods(n) {
      ...
      if (document.querySelector('[data-crs-test="new-payment-component"]'))
        return void console.log(
      ...
      const d = s.find((n) => n.id === m) || s[0],
        ...
        c = `\n      <div class="PaymentCombinedInformation" data-crs-test="new-payment-component">\n        <div class="crs-title">Choose your passport delivery timeline</div>\n        <div class="charge-payment-form">\n          <div class="ant-form-item">\n            <div class="ant-row ant-form-item-row">\n              <div class="ant-col ant-form-item-control">\n                <div class="ant-form-item-control-input">\n                  <div class="ant-form-item-control-input-content">\n                    <div aria-required="true" class="ant-radio-group ant-radio-group-outline payment-method-information" id="crsItemPriceChargeId" style="display: flex !important;">\n                      ${s
          ...
          .join(
            '',
          )}\n                    </div>\n                  </div>\n                </div>\n              </div>\n            </div>\n          </div>\n          <div class="payment-footer">\n            <div class="ant-typography GText" style="font-size: 16px; font-family: InterRegular, sans-serif; color: rgb(62, 62, 62); line-height: 140%; font-weight: 400; margin: 0px; letter-spacing: -0.2px; text-align: end;">\n              <p style="font-size: 16px; font-family: InterRegular, sans-serif; color: rgb(62, 62, 62); line-height: 140%; font-weight: 400; margin: 0px; letter-spacing: -0.2px; text-align: end;">${l}</p>\n            </div>\n          </div>\n        </div>\n      </div>\n    `;
      try {
        await Promise.race([
          i(
            '.passport_form form .list-blocks-with-fields li.list-blocks-with-fields__container_h2_birth_information',
          ),
          i(
            '.passport_form form .list-blocks-with-fields li.is_used_other_name',
          ),
        ]);
        const n = await i(this.newPaymentMethodsContainerId);
        if (
          n &&
          ...
          (console.log(
            ...
            'paymentMethodHeight:',
            o,
            'calculated topOffset for sticky button:',
            r,
          ),
            n.style.setProperty('--top-offset', `${r}px`),
            document
              .querySelectorAll(
                '[data-crs-test="new-payment-component"] #crsItemPriceChargeId input[type="radio"]',
              )
              .forEach((n) => {
                const e = n,
                  t = () => {
                    ...
                    const n = document.querySelectorAll(
                        '#crsItemPriceChargeId .ant-radio-wrapper',
                      ),
                      t = document.querySelectorAll(
                        '#crsItemPriceChargeId .ant-radio',
                      ),
                      i = document.querySelectorAll(
                        '#crsItemPriceChargeId input[type="radio"]',
                      );
                    (n.forEach((n) => {
                    ...
                    (a && a.classList.add('ant-radio-wrapper-checked'),
                      r && r.classList.add('ant-radio-checked'),
                  ...
                  i = () => {
                    ...
                    const t = e.closest('.ant-radio-wrapper'),
                      ...
                      o =
                        (null == (n = null == i ? void 0 : i.textContent)
                          ? void 0
                          : n.trim()) || 'Standard',
                      r = a[o] || a.Standard,
                      s = document.querySelector(
                        '[data-crs-test="new-payment-component"] .payment-footer p',
                      );
                    s && (s.textContent = r);
                  };
          ...
          const s = document.querySelector(
            '#crsItemPriceChargeId input[type="radio"]:checked',
          );
          (s &&
            ((this.selectedPaymentMethodId = s.value),
            this.persistSelectedPaymentMethod(this.selectedPaymentMethodId)),
            this.observeStickyButton());
        }
        return c;
      } finally {
        this.isRendering = !1;
              ...
              (a &&
                ...
                r &&
                  ((null == (i = r.textContent)
                    ? void 0
                    : i.includes('Guaranteed delivery in 4 weeks')) &&
                    (r.innerHTML =
                      '<span>4 weeks</span> delivery - guaranteed'),
                  (null == (o = r.textContent)
                    ? void 0
                    : o.includes('Guaranteed delivery in 2 week')) &&
                    (r.innerHTML =
                      '<span>2 weeks</span> delivery - guaranteed')));
            }));
        } finally {
          this.isProcessing = !1;
        }
    ...
    updateIntercomPosition() {
      this.isStickyStuck && this.isContainerVisible
        ? document.body.classList.add('crs-payment-button-stuck')
    ...
    observeStickyButton() {
      ...
      const i = document.querySelector('.sticky-sentinel');
      i && i.remove();
      const o = document.createElement('div');
      ((o.className = 'sticky-sentinel'),
        (o.style.height = '1px'),
        ...
        (this.containerObserver = new IntersectionObserver(
          ([n]) => {
            ((this.isContainerVisible = n.isIntersecting),
              this.updateIntercomPosition());
          },
          { threshold: 0 },
        )),
    ...
    cleanUp() {
      (this.stickyObserver &&
        (this.stickyObserver.disconnect(), (this.stickyObserver = null)),
  ...
  window.crsPassportAppFlowTestInstance ||
    ...
    new (class {
      ...
      async checkIsUserLoggedIn() {
        ...
        const { data: s, error: m } = await (async (i) => {
          try {
            ...
            return a ? { data: null, error: a } : { data: o, error: null };
          } catch (m) {
        ...
        const d =
          ...
          (r =
            ...
            (a =
              null ==
              (o = null == (i = null == s ? void 0 : s.data) ? void 0 : i.data)
                ? void 0
                : o.personal)
              ? void 0
              : a.communication)
            ...
            : r.email) && !m;
        return (
          d || sessionStorage.setItem('crs-first-time-user-checked', 'true'),
          d
        );
      }
      ...
      initComponents() {
        var n;
        (this.cleanUpComponents(), null == (n = this.payments) || n.init());
      }
      cleanUpComponents() {
        var n;
